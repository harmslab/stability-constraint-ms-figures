...
def get_rmsd(ob_file1, ob_file2, cmd=None, obj1_sel='name CA', obj2_sel='name CA', cleanup=True)->int:
    """
    gets rmsd of two objects
    ...
    sub_sel : str, optional
        substring to select, by default 'name CA'
    ...
    rmsd =  cmd.align(f'{ob1} and {obj1_sel}', f'{ob2} and {obj2_sel}', cycles=0)[0]
...
def fuse_on_helix_overlap(obj1, obj2, fusion_term="c_term", obj1_chain='A', obj2_chain='A', 
...
def heterodimer_setup():
    cmd.color("grey20", "chain B")
    cmd.color("grey80", "chain A")
